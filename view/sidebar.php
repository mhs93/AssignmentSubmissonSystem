            ...
            <li class="treeview">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="view-result.php"><i class="fa fa-circle-o"></i> <span> View Student Results</span></a></li>
                </ul>
            </li>
<!--            <li class="treeview">-->
<!--                <a href="#">-->
...
<!--                    <li><a href="unallocate.php"><i class="fa fa-circle-o"></i> Unallocate All Classrooms</a></li>-->
            ...
            <?php }elseif(session::get("userRole") == "2"){ ?>
<!--                <li class="treeview">-->
<!--                    <a href="#">-->
<!--                        <i class="fa fa-pie-chart"></i>-->
<!--                        <span>Teacher</span>-->
...
<!--                    </ul>-->
<!--                </li>-->
                <li><a href="view_assignment.php"><i class="fa fa-book"></i> <span> View Assignments</span></a></li>
                <li><a href="view-result.php"><i class="fa fa-book"></i> <span> View Result</span></a></li>
            <?php }else{?>
                <li><a href="assignment-submission.php"><i class="fa fa-book"></i> <span> Assignment Submission</span></a></li>
                <li><a href="view-result-for-student.php"><i class="fa fa-book"></i> <span> Result</span></a></li>
            <?php }?>
        </ul>
    </section>
</aside>
